<aside class="sidebar">
        ...
        <div class="sidebar-menu-area">
            <ul class="sidebar-menu" id="sidebar-menu">
                ...
                <li class="sidebar-menu-group-title">Items Data</li>
                <li class="dropdown">
                    <a href="javascript:void(0)">
                        <iconify-icon icon="material-symbols:category-outline" class="menu-icon"></iconify-icon>
                        <span>Categories</span>
                    </a>
                    <ul class="sidebar-submenu">
                        <li>
                            <a href="/newCatForm"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Add Category</a>
                        </li>
                        <li>
                            <a href="/manageCategory"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> Manage Categories</a>
                        </li>
                    </ul>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="sidebar-submenu">
                        <li>
                            <a href="/newItemForm"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> Add Item</a>
                        </li>
                        <li>
                            <a href="/manageItems"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> Manage Items</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-menu-group-title">Warehouse Data</li>
                <li class="dropdown">
                    <a href="javascript:void(0)">
                        <iconify-icon icon="ic:round-warehouse" class="menu-icon"></iconify-icon>
                        <span>Warehouses</span>
                    </a>
                    <ul class="sidebar-submenu">
                        <li>
                            <a href="/EntryForm"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Entry Transaction</a>
                        </li>
                        <li>
                            <a href="/disburseForm"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Disburse Transaction</a>
                        </li>
                        <li>
                            <a href="/newWarehouseForm"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Add Warehouse</a>
                        </li>
                        <li>
                            <a href="/manageWarehouses"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> Manage Warehouses</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-menu-group-title">Users Accounts</li>
                <li class="dropdown">
                    <a href="javascript:void(0)">
                    ...
                    <ul class="sidebar-submenu">
                        <li>
                            <a href="/newUserForm"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> Add User</a>
                        </li>
                        <li>
                            <a href="/manageUsers"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Manage Users</a>
                        </li>
                        <li>
                            <a href="/newRoleForm"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i> Add Role</a>
                        </li>
                        <li>
                            <a href="/manageRoles"><i class="ri-circle-fill circle-icon text-danger-main w-auto"></i> Manage Roles</a>
                        </li>
                        <li>
                            <a href="/resetPassForm"><i class="ri-circle-fill circle-icon text-danger-main w-auto"></i> Reset Password</a>
                        </li>
                    </ul>
                </li>
